...
import { getMapListService } from '@/api/map'
import defaultAvatar from '@/assets/avatar.jpg'
import MapSeriesSelect from './components/MapSeriesSelect.vue'
import MapDetailsDialog from './components/MapDetailsDialog.vue'
...
<template>
  <div class="map-page">
    <div class="header">
      <div class="text">
        <h1 style="font-size: 42px">地图介绍</h1>
        <p>
          在黎明杀机中，每一个系列地图做幻境，而每一个幻境都有不同的地图，在下面探索
          Dead by Daylight 的完整地图名单。
        </p>
        <div class="search">
          <div class="search-item">
            <label for="name">搜索地图名</label>
            <input
              type="text"
              id="name"
              v-model="params.name"
    ...
    <!-- 弹窗组件 -->
    <MapDetailsDialog ref="detailsDialog"></MapDetailsDialog>
  </div>
</template>
