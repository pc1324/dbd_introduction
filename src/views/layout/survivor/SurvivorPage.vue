...
const search = async (name) => {
  console.log('search')
  const res = await getSurvivorByNameService(name)
  console.log(res)
  dataList.value = res.data.data
}
// created
...
<template>
  <div class="survivor-page">
    <div class="header">
      <div class="text">
        <h1 style="font-size: 42px">逃生者介绍</h1>
        <p>
        ...
        <div class="search">
          <div class="search-item">
            ...
            <input
              ...
              placeholder="请输入角色姓名"
              maxlength="12"
              @blur="search(formModel.name)"
            />
            <el-icon @click="search(formModel.name)"><Search /></el-icon>
          </div>
        </div>
      </div>
      <div class="image">
